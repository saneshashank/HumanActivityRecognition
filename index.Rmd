...
# we can see that there are lot of coulmns which are with NA values
...
# we can see that our model is not able to classify model label D

# Check the out of sample prediction accuracy
confusionMatrix(dfSubTest$classe,predict(fit.rpart,dfSubTest))$overall[1]

# it also hasa very low accuracy, so we would be trying with random forest
